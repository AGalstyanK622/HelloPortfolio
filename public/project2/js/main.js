...
function getAcceleration(obj) {
    ...
    //------------------- BEGIN YOUR CODE
    r  = Math.sqrt(Math.pow(obj.pos.x,2) + Math.pow(obj.pos.y,2) + Math.pow(obj.pos.z,2));
    newAx = -(gravityConst * obj.pos.x) / Math.pow(r,2);
    newAy = -(gravityConst * obj.pos.y) / Math.pow(r,2);
    newAz = -(gravityConst * obj.pos.z) / Math.pow(r,2);
...
function getVelocity(obj) {
    ...
    var newVx = obj.v.x + a.x;
    var newVy = obj.v.y + a.y;
    var newVz = obj.v.z + a.z;
